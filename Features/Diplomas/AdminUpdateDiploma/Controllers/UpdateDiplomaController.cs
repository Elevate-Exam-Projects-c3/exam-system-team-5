...
using exam_system.Features.Diplomas.AdminUpdateDiploma.Orchestrators;
...
namespace exam_system.Features.Diplomas.AdminUpdateDiploma.Controllers
{
    ...
    public class UpdateDiplomaController : ControllerBase
    {
        ...
        {
            var result = await _mediator.Send(new UpdateDiplomaOrchestrator(id, request.Title,request.Description), cancellationToken);
